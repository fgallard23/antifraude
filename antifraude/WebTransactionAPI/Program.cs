...
using WebTransactionAPI.Queries;
...
dispatchers.RegisterHandler<NewJournalCommand>(commandHandler.HandleAsync);
builder.Services.AddSingleton<ICommandDispatcher>(_ => dispatchers);
